    ...
    <div className="my-12 flex flex-col gap-8 p-4 print:my-0 print:gap-5 print:p-0">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-2">
          <p>
            풀스택으로 시작해 사용자 경험을 직접 다루는 프론트엔드에 집중하고
            있습니다. 약 5년간 SaaS 플랫폼, 사내 협업 도구, 컨퍼런스 서비스 등
            다양한 B2B/B2C 프로덕트를 담당해왔습니다.
          </p>
          <p>
            레거시 프로젝트를 인수받아 개선하는 데 강점이 있으며 번들 크기 75%
            절감과 빌드 시간 60% 단축 등 측정 가능한 성과를 만들어 왔습니다.
            코드 레벨의 개선을 넘어, bstage에는 통합 계정 시스템을 도입해 멀티
            테넌시 환경의 회원가입 불편을 해소하고 UDC에는 QR 기반 입장 시스템을
            구축해 현장 입장 경험을 개선하는 등 프로덕트의 사용자 경험까지 함께
            개선해 왔습니다.
          </p>
        </div>
      </div>
